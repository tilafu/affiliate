-- Fix migration script to only create missing tier_quantity_configs table and data
...
DROP TRIGGER IF EXISTS trigger_update_tier_quantity_configs_updated_at ON tier_quantity_configs;
