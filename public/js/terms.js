// Terms and Conditions page translation support
...
// Function to update translations on the terms and conditions page
function updateTermsTranslations() {
  ...
  if (window.i18next && window.i18next.isInitialized) {
    ...
    if (typeof updateContent === 'function') {
      updateContent();
      console.log('Updated terms and conditions page translations');
    } else {
      console.warn('updateContent function not available');
    }
  } else {
    console.warn('i18next not initialized yet for terms and conditions page');
  }
}
